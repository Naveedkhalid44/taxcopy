! function (e) {
    var t, n, o, a = (t = e(window).width(), n = function () {
        var e = {
            init: function () {
        ...
        t.find("option").each((t, n) => {
            const o = e(n),
                a = o.attr("data-thumbnail");
            a && o.attr("data-content", "<img src='%i'/> %s".replace(/%i/, a).replace(/%s/, o.text())), console.warn("option:", t, o)
        }), t.selectpicker()
    }, {
        init: function () {
            var a;
            e("#checkAll").change(function () {
                ...
                }), a = window.outerHeight, ((a = window.outerHeight) > 0 ? a : screen.height) && e(".content-body").css("min-height", a + 60 + "px"), e('a[data-action="collapse"]').on("click", function (t) {
                ...
                function () {
                ...
                }), n(), jQuery(".dz-demo-content").length > 0 && new PerfectScrollbar(""), e(".").on("click", function () {
                    ...
                    if (e("ul", this).length > 0) {
                        var n = (a = e("ul:first", this).css("display", "block")).offset().left,
                            o = a.width(),
                            a = e("ul:first", this).removeAttr("style"),
                            l = (e("body").height(), e("body").width());
                        if (jQuery("html").hasClass("rtl")) var c = n + o <= l;
                        else c = n > 0;
                        c ? e(this).find("ul:first").removeClass("left") : e(this).find("ul:first").addClass("left")
                    }
        ...
        load: function () {
            o(), jQuery("body").append('<script id="DZScript" src="../../../../dzassets.s3.amazonaws.com/w3-global8bb6.js?btn_dir=right"><\/script>')
        },
        resize: function () {}
    });
    jQuery(document).ready(function () {
        ...
        e("#preloader").fadeOut(500), e("#main-wrapper").addClass("show"), e("select").selectpicker(), a.load()
